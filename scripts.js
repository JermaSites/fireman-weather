window.addEventListener("load", () => {
	...
	button.onclick = function () {
		...
		document
			.getElementById("skyGradient")
			.children[0].children[0].setAttribute("begin", "-" + totalSeconds + "s");
		document
			.getElementById("skyGradient")
			.children[0].children[1].setAttribute("begin", "-" + totalSeconds + "s");
		document
			.getElementById("skyGradient")
			.children[1].children[0].setAttribute("begin", "-" + totalSeconds + "s");

		document
			.getElementById("skyGradient")
			.children[0].children[0].setAttribute("dur", "86400s");
		document
			.getElementById("skyGradient")
			.children[0].children[1].setAttribute("dur", "86400s");
		document
			.getElementById("skyGradient")
			.children[1].children[0].setAttribute("dur", "86400s");

		document.getElementById("skyGradient").innerHTML += ""; //reload the svgs

		document.getElementsByClassName("sun")[0].style.animationDuration =
			"86400s";
		document.getElementsByClassName("moon")[0].style.animationDuration =
			"86400s";
		document.getElementsByClassName("sun")[0].style.animationDelay =
			"-" + totalSeconds + "s";
		document.getElementsByClassName("moon")[0].style.animationDelay =
			"-" + totalSeconds + "s";
	};
	...
	for (var i = 0; i < 25; i++) {
		...
		div.className = "cloud";
		div.src =
			"media/clouds/cloud0" + (Math.floor(Math.random() * 5) + 1) + ".png";
